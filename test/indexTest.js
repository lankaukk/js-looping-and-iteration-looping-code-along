...
describe( 'index.js', () => {
  ...
  describe( 'writeCards()', () => {
    ...
    it( 'returns an array of thank you messages for each name provided to the function', () => {
      expect( writeCards( [ 'Lisa', 'Kaitlin', 'Jan' ], 'birthday' ) )
        .to.deep.eq( [ 'Thank you, Lisa, for the wonderful birthday gift!', 'Thank you, Kaitlin, for the wonderful birthday gift!', 'Thank you, Jan, for the wonderful birthday gift!' ] );
    } );
  } );
